...
def _cmd_install(args):
    ...
    if not dry_run:
        ...
        if safe_mode:
            ...
            print("   https://github.com/mradulsinghal/omnipulse")
...
_UPDATE_INSTRUCTIONS = (
    ...
    "  帮我更新 Agent Reach：https://raw.githubusercontent.com/mradulsinghal/omnipulse/main/docs/update.md\n"
    "仅更新本体（不含上游工具和 skill）：\n"
    "  pip install --upgrade https://github.com/mradulsinghal/omnipulse/archive/main.zip"
)
...
def _cmd_check_update():
    ...
    release_url = "https://api.github.com/repos/mradulsinghal/omnipulse/releases/latest"
    commit_url = "https://api.github.com/repos/mradulsinghal/omnipulse/commits/main"
...
def _cmd_watch():
    ...
    resp, err, _attempts = _github_get_with_retry(
        "https://api.github.com/repos/mradulsinghal/omnipulse/releases/latest",
        timeout=10,
        retries=2,
    )
    ...
    if update_available:
        ...
        print("    帮我更新 Agent Reach：https://raw.githubusercontent.com/mradulsinghal/omnipulse/main/docs/update.md")
