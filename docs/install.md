...
```
帮我安装 Agent Reach：https://raw.githubusercontent.com/mradulsinghal/omnipulse/main/docs/install.md
```

> 🛡️ **Safe by default:** `agent-reach install` only checks the machine and lists missing dependencies:
> ```
> 帮我安全检查并安装 Agent Reach：https://raw.githubusercontent.com/mradulsinghal/omnipulse/main/docs/install.md
> ```
...
```bash
# 推荐：pipx（最省心）
pipx install https://github.com/mradulsinghal/omnipulse/archive/main.zip
...
> python -m pip install https://github.com/mradulsinghal/omnipulse/archive/main.zip
...
如果有新版本可用，问用户是否要升级（把这句话发给用户的 Agent 即可完整更新：帮我更新 Agent Reach：https://raw.githubusercontent.com/mradulsinghal/omnipulse/main/docs/update.md）。
```
